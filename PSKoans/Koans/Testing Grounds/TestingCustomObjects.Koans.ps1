...
<#
    About PSObject
    PSObject plays a critical role in powershell every object in .net can be wrapped up in it in order to manipulate output for use in powershell.
    PSObject 


    About PSCustomObject

    PSCustomObjects have a very unique and Critical Role in Powershell.
