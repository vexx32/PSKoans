...
[Koan(Position = 101, HelpPath = "about_comparison_operators", HelpURL = "https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_comparison_operators?view=powershell-6" )]
param()
<#
    Getting Started
