...
@{
    ...
    Copyright             = '(c) 2018 Joel Sallow (/u/ta11ow). All rights reserved.'
    ...
    ScriptsToProcess      = @('ExportedTypes.ps1')
    ...
    FunctionsToExport     = @('Get-Blank','Invoke-Advice','Measure-Karma','Register-Advice')
